...
<div class="card-box">
  ...
  <a href="{{ route('admin.permission.create') }}" class="btn btn-info">Add New</a>
  ...
  <table class="table table-striped table-bordered table-datatable">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a class="btn btn-success" href="{{ route('admin.permission.edit',$permission->id) }}">E</a>  
          <button value="{{ route('admin.permission.destroy',$permission->id) }}" class="btn btn-danger btn-modal-confirm">D</button>  
        </td>
      </tr>
      @endforeach
    </tbody>
