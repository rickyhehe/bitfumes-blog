...
<div class="card-box">
  ...
  <a href="{{ route('admin.role.create') }}" class="btn btn-info">Add New</a>
  ...
  <table class="table table-striped table-bordered table-datatable">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>{{ $role->name }}</td>
        <td>
          <a class="btn btn-success" href="{{ route('admin.role.edit',$role->id) }}">E</a>  
          <button value="{{ route('admin.role.destroy',$role->id) }}" class="btn btn-danger btn-modal-confirm">D</button>  
        </td>
      </tr>
      @endforeach
    </tbody>
